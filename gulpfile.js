...
gulp.task("copy-lib-css", function () {
  ...
  .pipe(gulp.dest(csspaths.wwwroot.lib));
});
...
// Task 'style-vendor' : Transform SCSS to CSS, Minify CSS, Add Sourcemaps, Correct Line ending
//============================================================================
...
gulp.task('css', gulp.series('copy-lib-css', gulp.parallel('style', 'style-vendor')));
